...
const KineticWeapon = () => {
    ...
    let images = [blGun, railgun, coilgun];
    let imgTitles = ['Blade runner`s gun', 'Railgun', 'GR-1 ANVIL'];
    ...
    return (
        <div className='container weapons-page'>
            ...
            {/* <WeaponsInfo img = {blGun} imgTitle = {'Blade runner`s gun'} texts = {texts[0]} />
            <WeaponsInfo img = {railgun} imgTitle = {'Railgun'} texts = {texts[1]} />
            <WeaponsInfo img = {coilgun} imgTitle = {'GR-1 ANVIL'} texts = {texts[2]} /> */}
        </div>
    );
};
